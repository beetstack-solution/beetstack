...
export const DIFFERENCES: DifferenceItem[] = [
  {
    ...
    description:
      "Deep technical background in building real-world, high-impact systems that drive critical infrastructure.",
    span: "md:col-span-1",
  ...
  },
  {
    ...
    description:
      "Architecting software for highly secure and controlled environments with extreme resilience.",
    span: "md:col-span-2",
    bgColor: "bg-brand-green",
    iconPaths: ["M12 1L3 5v6c0 5.5 3.8 10.7 9 12 5.2-1.3 9-6.5 9-12V5L12 1z"],
  },
  {
    id: "custom",
    title: "Fully Custom",
    ...
    iconPaths: [
      ...
      "M12 15.5c-1.9 0-3.5-1.6-3.5-3.5s1.6-3.5 3.5-3.5 3.5 1.6 3.5 3.5-1.6 3.5-3.5 3.5z",
    ],
  },
  {
    id: "global",
  ...
  },
  {
    ...
    description:
      "Unwavering focus on scalability, benchmarks, and dedicated long-term technical evolution.",
    span: "md:col-span-1",
    bgColor: "bg-brand-lite-red",
    iconPaths: ["M16 6l2.29 2.29-4.88 4.88-4-4L2 16.59 3.41 18l6-6 4 4 6.3-6.29L22 12V6z"],
  },
  {
    id: "innovation",
    title: "Technical Precision",
    description:
      "Executing complex technical roadmaps with extreme engineering meticulousness and accuracy.",
    span: "md:col-span-2",
    bgColor: "bg-brand-green",
    iconPaths: [
      "M12 2L12 22",
