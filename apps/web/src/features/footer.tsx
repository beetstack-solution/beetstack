  ...
  return (
    <footer className="relative bg-background py-20 px-6 lg:px-12 overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 opacity-[0.03] pointer-events-none select-none">
        <h2 className="text-[12vw] font-black leading-none tracking-tighter select-none text-black">BEETSTACK</h2>
      </div>

      <div className="w-full h-1 bg-brand-lite-red rounded-full justify-self-center absolute bottom-0"></div>
    </footer>
  );
}
