...
const TECHS: { name: string; category: string; iconKey: IconKey; color: string; glow: string }[] = [
  { name: "Next.js",      category: "Framework",    iconKey: "Nextjs",      color: "#ffffff",  glow: "rgba(255,255,255,0.12)" },
  ...
  { name: "Three.js",     category: "3D / WebGL",   iconKey: "ThreeJs",     color: "#ffffff",  glow: "rgba(255,255,255,0.10)" },
  ...
  { name: "Vercel",       category: "Deployment",   iconKey: "Vercel",      color: "#ffffff",  glow: "rgba(255,255,255,0.10)" },
  ...
  { name: "OpenAI",       category: "AI / LLM",     iconKey: "OpenAI",      color: "#ffffff",  glow: "rgba(255,255,255,0.14)" },
];
    ...
    <Image src={`/images/leef.png`} alt="Leef" width={50} height={50} className="-mb-2" />
      ...
      >
        ...
        <svg viewBox="0 0 88 88" className="absolute inset-0 w-full h-full" fill="none">
          ...
          {/* Filled glow core on hover */}
          {hovered && (
            <circle cx="44" cy="44" r="20" fill="#a21c3c" opacity="0.12" />
          )}
        </svg>
