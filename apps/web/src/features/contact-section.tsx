...
export const ContactSection = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // In a real app, you'd use fetch('/api/send-email', { method: 'POST', body: JSON.stringify(formData) })
    try {
      console.log("Sending message to info@beetstack.in:", formData);
  ...
  const contactInfo = [
    {
      icon: "Mail",
      label: "Email",
      value: "info@beetstack.in",
      href: "mailto:info@beetstack.in",
    },
    {
      icon: "Globe",
      label: "Website",
      value: "www.beetstack.in",
      href: "https://www.beetstack.in",
    },
    {
      icon: "WhatsApp",
      label: "WhatsApp",
      value: "+91 6282345226",
      href: "https://wa.me/916282345226",
    },
    {
      icon: "Phone",
      label: "Roshin",
      value: "+91 9037275308",
      href: "tel:+919037275308",
    },
  ];

  return (
    <section id="contact" className="relative py-24 lg:py-40 bg-brand-lite-red overflow-hidden selection:bg-white selection:text-brand-lite-red">
      {/* Decorative Elements */}
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-start">
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true }}
            className="p-8 lg:p-12 rounded-[2.5rem] bg-white shadow-2xl shadow-black/10"
          >
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <Button
                ...
                className={`w-full h-14 rounded-2xl font-heading font-medium uppercase tracking-widest text-xs flex items-center justify-center gap-2 transition-all ${formState === "success" ? "bg-green-500 hover:bg-green-600" : "bg-brand-lite-red hover:bg-brand-red"} text-white`}
              >
